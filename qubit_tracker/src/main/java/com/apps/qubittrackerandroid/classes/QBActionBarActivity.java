...
public class QBActionBarActivity extends Activity implements View.OnClickListener, View.OnTouchListener {
...
//        QBTrackingManager.sharedManager().registerViewEvent(vID, this);
    ...
    public void setContentView(View view) {
        ...
        Log.i("-----QBActionBarActivity : setContentView : view", view.getClass().toString() + "");
    }

    @Override
    public void setContentView(View view, ViewGroup.LayoutParams layoutParams) {
        super.setContentView(view, layoutParams);
        Log.i("-----QBActionBarActivity : setContentView : view, params", view.getClass().toString() + " / " + layoutParams.toString());
    }
